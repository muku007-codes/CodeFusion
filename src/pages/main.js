...
const main = () => {
  return (
    <>
      {/* <Particle id='particle' color='#10162f' /> */}
      <div className='container'>
        <div className='section1'>
          <div className="section1-left">
            <div className='logo1'>CodeFusion</div>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sit amet neque tincidunt, mattis turpis ut, maximus ante. Phasellus id nisl arcu. Pellentesque sed viverra.</p>
